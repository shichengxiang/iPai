...
//
//import static com.zj.ipai.ipai.R.mipmap.head;
//
///**
// * name of class: iPai
// * creater: scx
// * time: 2017/3/29 19:18
// */
//
...
//          mHeader= LayoutInflater.from (getContext ()).inflate (R.layout.item_tab,null);
////          mCircleView = new android.support.v4.widget.CircleImageView (getContext (), CIRCLE_BG_LIGHT);
...
////          }
//          mHeader.clearAnimation ();
//          mHeader.startAnimation (mScaleAnimation);
//     }
//
//     /**
...
//      */
//     public void setOnChildScrollUpCallback(@Nullable android.support.v4.widget.SwipeRefreshLayout.OnChildScrollUpCallback callback) {
...
//           */
//          boolean canChildScrollUp(android.support.v4.widget.SwipeRefreshLayout parent, @Nullable View child);
//     }
//
//}
