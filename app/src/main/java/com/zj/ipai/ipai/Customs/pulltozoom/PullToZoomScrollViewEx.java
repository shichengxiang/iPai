...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
     ...
     private int mHeaderWidth = getResources ().getDisplayMetrics ().widthPixels;
     ...
     protected void pullHeaderToZoom(int newScrollValue) {
          ...
          localLayoutParams.width = Math.abs (newScrollValue) + mHeaderWidth;
          ...
          if (isCustomHeaderHeight) {
               ...
               zoomLayoutParams.width = Math.abs (newScrollValue) + mHeaderWidth;
               ...
               if (mZoomView != null) {
                    ...
                    if ((!mIsFinished) && (mScale > 1.0D)) {
                         ...
                         if (f2 > 1.0F) {
                              ...
                              localLayoutParams.width=((int) (f2 * mHeaderWidth));
                              mHeaderContainer.setLayoutParams (localLayoutParams);
                              if (isCustomHeaderHeight) {
                                   ...
                                   zoomLayoutParams.width=((int) (f2 * mHeaderWidth));
                                   mZoomView.setLayoutParams (zoomLayoutParams);
                              }
                              post (this);
                              return;
